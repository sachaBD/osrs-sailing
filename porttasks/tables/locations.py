"""Read/write tables/locations.tsv, the hand-editable port reference table.

Every column is yours to edit; `wiki.py` only fills blanks unless forced.
"""
from __future__ import annotations

from ..paths import LOCATIONS as PATH
