"""Trace the water a ship could actually take, as rows for waypoints.tsv.

    python3 -m routing.suggest Entrana "Musa Point"
...
def main(argv: list[str]) -> None:
    if len(argv) != 2:
        raise SystemExit('usage: python3 -m routing.suggest <port> <port>')
